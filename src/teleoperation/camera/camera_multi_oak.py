...
class CameraMultiOak:
    def __init__(
        ...
        self.stereo_resolution = display_config.stereo_resolution
        self.color_resolution = display_config.color_resolution

        self.display = DisplayCamera(display_config.display_mode, display_config.display_resolution, display_crop_sizes)
        if self.eval_mode:
            self.recorder = None
        else:
